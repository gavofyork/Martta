...
SOURCES +=  ./ValueDefiner.cpp Interfaces/Corporal.cpp Interfaces/Conditional.cpp ./Statement.cpp ./Primary.cpp ./BareTyped.cpp ./Typed.cpp ./Untyped.cpp ./Compound.cpp
