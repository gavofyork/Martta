...
!win32:DATA.commands = @echo "Copying data..." && mkdir -p "$$DESTDIR/Data"  && cp "$$PWD/Support/in.svg" "$$DESTDIR/Data" && cp "$$PWD/Support/out.svg" "$$DESTDIR/Data" && cp "$$PWD/Support/GlobalReferenced.svg" "$$DESTDIR/Data"
