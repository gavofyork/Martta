...
class M_CLASS M_API_Statements WhileLoop: public_super Loop, public_interface Conditional
{
	MARTTA_PROPER(Loop)
...
class M_CLASS M_API_Statements UntilLoop: public_super WhileLoop
{
