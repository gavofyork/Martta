...
class M_API_Concept Depender: public Familial
{
...
protected:
	...
	/// @note By default, it does nothing.
	virtual void						onDependencyChanged(int /*_aspect*/, Concept* /*_e*/) { }
	/// Called when:
	...
	virtual void						onDependencySwitched(Concept* _e, Concept* /*_old*/) { onDependencyChanged(Dependee::AllAspects, _e); }
	...
	/// position).
	/// @note By default, it just called the onDependencyChanged() method.
	virtual void						onChildMoved(Concept* _e, int /*_oldIndex*/) { onDependencyChanged(Dependee::AllAspects, _e); }
	/// Called when:
	...
	/// @note By default, it just called the onDependencyChanged() method.
	virtual void						onDependencyAdded(Concept* _e) { onDependencyChanged(Dependee::AllAspects, _e); }
	/// Called when:
	...
	/// @note By default, it does nothing.
	virtual void						onDependencyRemoved(Concept*, int /*_index*/) {}
	...
	virtual void						childSwitched(Concept* _currentChild, Concept* _exChild) { if (!m_isAsleep) ChangeMan::get()->childSwitched(this, _currentChild, _exChild); }
	virtual void						childRemoved(Concept* _exChild, int _exChildsIndex) { if (!m_isAsleep) ChangeMan::get()->childRemoved(this, _exChild, _exChildsIndex); }
	virtual void						childMoved(Concept* _child, int _originalIndex) { if (!m_isAsleep) ChangeMan::get()->childMoved(this, _child, _originalIndex); }
	virtual void						parentAdded() { if (!m_isAsleep) ChangeMan::get()->parentAdded(this); }
	virtual void						parentSwitched(Concept* _exParent) { if (!m_isAsleep) ChangeMan::get()->parentSwitched(this, _exParent); }
	virtual void						parentRemoved(Concept* _exParent) { if (!m_isAsleep) ChangeMan::get()->parentRemoved(this, _exParent); }
	virtual void						dependencySwitched(Concept* _currentDependency, Concept* _exDependency) { if (!m_isAsleep) ChangeMan::get()->dependencySwitched(this, _currentDependency, _exDependency); }
