...
private:
	virtual QList<ValueDefiner*>		applicableMembers(Entity* _s = 0, bool _isConst = false) const { return child() ? child()->applicableMembers(_s, _isConst) : Super::applicableMembers(_s); }
