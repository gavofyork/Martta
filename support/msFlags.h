...
public:
	...
	inline Flags& set(Flag _f, bool _v = true) { m_value = (test(_f) != _v) ? m_value ^ _f : m_value; return *this; }
	inline bool test(Flag _f) const { return m_value & _f; }
...
inline Flag ## s operator|(Flag _a, Flag _b) { return Flag ## s(_a|_b); } \
inline Flag ## s operator|(Flag _a, Flag ## s _b) { return _b | _a; } \
enum{}
