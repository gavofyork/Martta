...
public:
	...
	m_inline TextStream& operator<<(float _c) { m_buffer += String::number(_c); return *this; }
	m_inline TextStream& operator<<(double _c) { m_buffer += String::number(_c); return *this; }
	m_inline TextStream& operator<<(unsigned char _c) { m_buffer += String::number((unsigned long)_c); return *this; }
	m_inline TextStream& operator<<(short _c) { m_buffer += String::number((long)_c); return *this; }
	m_inline TextStream& operator<<(unsigned short _c) { m_buffer += String::number((unsigned long)_c); return *this; }
	m_inline TextStream& operator<<(int _c) { m_buffer += String::number((long)_c); return *this; }
	m_inline TextStream& operator<<(unsigned int _c) { m_buffer += String::number((unsigned long)_c); return *this; }
	m_inline TextStream& operator<<(long _c) { m_buffer += String::number(_c); return *this; }
	m_inline TextStream& operator<<(unsigned long _c) { m_buffer += String::number(_c); return *this; }
